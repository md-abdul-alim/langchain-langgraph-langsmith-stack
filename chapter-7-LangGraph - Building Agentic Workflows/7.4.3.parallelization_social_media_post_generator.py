...
def generate_instagram(state: OverallState) -> OverallState:
    """Generate an engaging Instagram post with emojis and hasttags"""
...
def generate_twitter(state: OverallState) -> OverallState:
    """Generate an engaging Twitter post with emojis and hasttags"""
    print("Twitter Generator: Creating post...")

    prompt = f"""
        Create an Twitter post about: {state['topic']}
...
def generate_Linkedin(state: OverallState) -> OverallState:
    """Generate an engaging Linkedin post with emojis and hasttags"""
    print("Linkedin Generator: Creating post...")

    prompt = f"""
        Create an Linkedin post about: {state['topic']}
        ...
        Make it perfect for Linkedin's fast-paced environment.
    """
...
def aggregate_posts(state: OverallState) -> OverallState:
    """Combine all platform post into a formatted final output"""
    print("Aggregator: Combining all post...\n")
