...
def research_worker(state: WorkerState) -> OverallState:
    ...
    3. INSIGHTS & ANALYSIS
        ...
        - How does it relate to this broader topic?
    4. SOURCES & CREDIBILITY
        - Types of sources you would consult (academic, industry, government, etc.)
    5. IMPLICATIONS
        - Why does this matter for understanding this overall topic?
...
def synthesize_report(state: OverallState) -> OverallState:
    ...
    You have received detailed findings from {len(state['worker_findings'])} specialized researchers, each investigating a different aspect of this topic.
    ...
    IMPORTANT:
    - Write this a unified, flowing report, NOT as separate sections from each researcher
...
print("="*70)
print(f"FINAL SYNTEHESIZED RESULT")
print("="*70)
